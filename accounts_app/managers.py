...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, email, password, first_name, last_name, passport_number, **extra_fields):
        """
        ...
        user = self.model(email=email, first_name=first_name, last_name=last_name,
                          passport_number=passport_number, **extra_fields)
        user.set_password(password)
        user.save()
        return user

    def create_superuser(self, email, password, first_name="Super", last_name="User",
                         passport_number="00000000", **extra_fields):
        """
        ...
        return self.create_user(email, password, first_name, last_name, passport_number, **extra_fields)
